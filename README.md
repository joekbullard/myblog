...
Note - this is no longer use as my [current blog](https://www.joekbullard.xyz), django is great for many things, but after deploying this on my raspberry pi, I soon learnt there are much better (simpler) ways of building a blog than Django.
